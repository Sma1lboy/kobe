...
- **User-facing docs set:** [`docs/CONCEPTS.md`](./docs/CONCEPTS.md), [`docs/CONFIGURATION.md`](./docs/CONFIGURATION.md), [`docs/ENGINES.md`](./docs/ENGINES.md), [`docs/SESSIONS.md`](./docs/SESSIONS.md), [`docs/CLI.md`](./docs/CLI.md) — behavior verified against source at writing time. When you change config keys, CLI verbs, engine support, or session/persistence behavior, update the matching page in the same PR.
