 ...
 * paths (chat-tab close, engine-tab exit). Same #205-class leak as whole-
 * session kills: 2026-07-07 the un-swept window closes had accumulated 41
 * orphaned pane hosts (~8.7GB) and pushed the machine into OOM kills.
 */
