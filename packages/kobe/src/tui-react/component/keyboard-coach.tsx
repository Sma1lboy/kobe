...
export function KeyboardCoach(props: { focused: PaneId }) {
  ...
  }, [kv, last, prefixKey, props.focused, sidebarNavKey, sidebarSelectKey, step])

  const unavailableStep =
    (step === 0 && (sidebarNavKey === null || sidebarSelectKey === null)) || (step === 1 && prefixKey === null)
    ...
    >
      ...
      <text fg={theme.text} wrapMode="word">
        {step === 0
          ...
          : step === 1
            ? t("help.coach.step1", { key: formatChord(prefixKey ?? "") })
            : null}
      </text>
    </box>
  )
