 ...
 */
export function readClipboardImageToFile(destPath: string): ClipboardImageResult | null {
...
function readClipboardImageMacOS(destPath: string): ClipboardImageResult | null {
