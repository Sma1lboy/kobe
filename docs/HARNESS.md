...
runs the committed browser journey on the supported macOS Intel runner after
ad-hoc signing node-pty's native pair for the hosted image. The Ubuntu V8 coverage job remains
